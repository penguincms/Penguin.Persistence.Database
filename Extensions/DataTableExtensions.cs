...
#pragma warning restore CS1591 // Missing XML comment for publicly visible type or member
    {
        ...
        /// <returns></returns>
        public static T Single<T>(this DataTable dt, bool IgnoreCase = false)
        {
            if (dt.Rows.Count > 1 || dt.Columns.Count > 1)
            { throw new Exception("Called Single on a data table with more than one result"); }
        ...
        public static DataTable ToDataTable(this System.Collections.Generic.IEnumerable<object> objList, bool ShowAllFields = false)
        {
            ...
            {
                //ScaffoldColumnAttribute scaffold = thisProp.GetCustomAttribute<ScaffoldColumnAttribute>();
                DisplayAttribute displayAttribute = thisProp.GetCustomAttribute<DisplayAttribute>();

                bool display = true; //keyAttribute == null;

                //if (scaffold != null)
                //{
                //    display = display && scaffold.Scaffold;
                //}
